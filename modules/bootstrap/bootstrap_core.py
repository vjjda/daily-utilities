...
def generate_script_entrypoint(config: Dict[str, Any], cli_interface_override: Optional[str] = None) -> str:
    ...
    try:
        ...
        generated_content = {
            ...
            # --- THAY ĐỔI TRUYỀN THAM SỐ VÀO ĐÂY ---
             "script": generate_script_entrypoint(config, cli_interface_override=cli_args.interface),
