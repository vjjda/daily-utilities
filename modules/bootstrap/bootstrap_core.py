...
from .bootstrap_internal.bootstrap_loader import (
...
def _run_bootstrap_logic(
    ...
    if not spec_file_path_str:
        raise ValueError(
            "Lỗi logic: _run_bootstrap_logic được gọi mà không có spec_file_path_str."
        )
