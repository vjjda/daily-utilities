# Path: modules/no_doc/ndoc_internal/task_dir.py
import logging
import argparse
...
from . import load_config_files, merge_ndoc_configs, scan_files, analyze_file_content


from ..no_doc_executor import print_dry_run_report_for_group

__all__ = ["process_ndoc_task_dir"]

FileResult = Dict[str, Any]


def process_ndoc_task_dir(
    scan_dir: Path,
