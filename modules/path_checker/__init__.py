...
(defined in __all__) from its internal modules.

External consumers (like scripts/check_path.py) should *only* import from here.
"""
...
# We only export symbols from these files to the public gateway.
# _rules and _scanner are considered internal implementation details.
